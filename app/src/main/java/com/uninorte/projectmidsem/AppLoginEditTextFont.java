...
public class AppLoginEditTextFont extends android.support.v7.widget.AppCompatEditText {

    private int typefaceType;
    private RobotoFamily mFontFactory;

    public AppLoginEditTextFont(Context context, AttributeSet attrs) {
        super(context, attrs);

        applyCustomFont(context, attrs);
    }

    public AppLoginEditTextFont(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        applyCustomFont(context, attrs);
    }

    public AppLoginEditTextFont(Context context) {
        super(context);
    }
